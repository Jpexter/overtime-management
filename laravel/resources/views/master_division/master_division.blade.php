      ...
      <div class="col-11">
          <div class="d-flex justify-content-end">
              <button class="btn btn-sm bg-success" style="width: 70px;">
                  <a href="{{$baseUrl}}/masterdivision/create">+ Add</a>
              </button>
          </div>
        <div class="card">
          <!-- /.card-header -->
              ...
              <tbody>
                @foreach ($divisions as $division)
                    <tr>
                        ...
                        <td>
                            <button class="btn">
                                <a href="{{$baseUrl}}/masterdivision/{{$division->id_division}}/edit">
                                    <i class="fas fa-edit text-warning"></i> <!-- Ikon Edit -->
                                </a>
                            </button>
                            <form action="{{$baseUrl}}/masterdivision/{{$division->id_division}}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
                                <button class="btn">
                                    <a href="">
