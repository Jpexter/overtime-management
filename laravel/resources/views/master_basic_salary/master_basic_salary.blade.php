        ...
        <div class="col-11">
            <div class="d-flex justify-content-end">
                <button class="btn btn-sm bg-success" style="width: 70px;">
                    <a href="{{$baseUrl}}/masterbasicsalary/create">+ Add</a>
                </button>
            </div>
          <div class="card">
            <!-- /.card-header -->
                ...
                <tbody>
                    @foreach ($basicSalaries as $basicSalary)
                        <tr>
                            ...
                            <td>
                                <button class="btn">
                                    <a href="{{$baseUrl}}/masterbasicsalary/{{$basicSalary->id_basic_salary}}/edit">
                                        <i class="fas fa-edit text-warning"></i>
                                    </a>
                                </button>
                                <form action="{{$baseUrl}}/masterbasicsalary/{{$basicSalary->id_basic_salary}}" method="POST" class="d-inline">
                                    @method('DELETE')
                                    @csrf
