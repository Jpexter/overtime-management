...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Master Project</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="card card-default">
        ...
        <!-- /.card-header -->
      <form action="{{ route('masterproject.update', $project->id_project) }}" method="POST">
        @method('put')
          ...
          <div class="row d-flex">
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="project_name" class="form-control" id="project_name" placeholder="Project name" required value="{{ old('project_name', $project->project_name) }}">
                </div>
